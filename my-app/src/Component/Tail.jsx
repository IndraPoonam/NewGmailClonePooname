...
function Tail() {
  return (
    ...
    <center><h1 class='logo22'><div id="logo" class="google-logo" title="Google">
    ...
    <b class="title">Sign in </b><br></br>
    <b>to continue to Gmail</b></center>
    <form   class="login-form">
      <input type="email" class="email22" name="email" placeholder="Email or phone" required/>
      <b class="forgot-password">Forgot email?</b><br></br><br></br>
   <h2 class="line1">Not your computer? Use a Private Window to sign in.</h2>
   <h3 class="line">Learn more about using Guest mode</h3>
    <spam class="create-account">Create account</spam> 
    <button class="button22" type="submit">Next</button>
   </form>
  </div>
<center>
  <div class="container-2">
    <ul class="list-2">
    <li>English(United States)   <i class="fa-solid fa-caret-down"></i></li>
<li>Help</li>
<li>Privacy</li>
<li>Terms</li></ul>
  </div></center>
