...
import category from '../icons/hangouts-common.png'
import person from '../icons/person_black_24dp.svg'
import hangout from '../icons/hangout_black_20dp.png'
  ...
  return (
      ...
      <div class="left-sidebar-compose">
        <button class="sidebar-btn-compose">
          <img src={create} alt="Compose a new email" class="sidebar-btn-compose-icon"/>
      ...
      <div class="left-sidebar-connect" >
        ...
        <div class="connect hangouts" >
          ...
          <div class="hangouts-img" >
            <img class="category-img" src={category} alt=""/>
          </div>
      ...
      <div class="left-sidebar-footer">
        ...
        <button class="btn btn-sidebar">
          <img src={person} class="btn-icon-sidebar btn-icon-sm"/>
        </button>
